...
\newcommand{\authorOne}{Anders Bjørk}
\newcommand{\authorTwo}{Dominik Weickgenannt}
\newcommand{\authorThree}{Jorge Rodriguez Marin}
\newcommand{\authorFour}{Martin Groth Albøge}
\newcommand{\authorFive}{Steffen Ivan Nielsen}
\newcommand{\authorSix}{Thor Stærk Stenvang}
\newcommand{\authorSeven}{Timon Tomás}
\newcommand{\authorEight}{Yonas Alizadeh}
